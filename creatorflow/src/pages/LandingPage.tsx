  ...
  return (
    <div className="min-h-dvh bg-background text-foreground">
      ...
      <div className="relative z-20 flex min-h-dvh flex-col">
        <header className="mx-auto flex w-full max-w-6xl items-center justify-between px-5 py-5 safe-top safe-x sm:px-6">
          <Logo />
        ...
        <section className="mx-auto flex w-full max-w-3xl flex-1 flex-col justify-center px-5 pb-16 sm:px-6">
          <h1 className="text-[2.5rem] font-semibold leading-[1.08] tracking-tight sm:text-6xl sm:leading-[1.05]">
            {tr("app.heroTitle")}
          </h1>
          <div className="mt-10">
            <Button className="h-12 px-8 text-[15px]" onClick={() => void handleEnterDemo()}>
              {tr("login.start")}
      ...
      <main className="relative z-10">
        <section
          id="login"
          className="border-t border-border bg-card/25 py-16 sm:py-20"
        >
