...
export const translations: Record<Locale, Translations> = {
  fr: {
    ...
    "paywall.nativeUnavailable": "Achats intégrés non disponibles — le bridge StoreKit n'est pas encore connecté.",
    "paywall.stubNote": "Facturation App Store activée une fois le plugin Capacitor branché.",
  ...
  en: {
    ...
    "paywall.nativeUnavailable": "In-app purchases unavailable — StoreKit bridge not connected yet.",
    "paywall.stubNote": "App Store billing enabled once the Capacitor plugin is wired.",
