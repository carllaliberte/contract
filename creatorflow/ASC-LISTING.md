...
| **Âge** | 4+ |
| **Prix** | Gratuit |
| **Keywords** (≤100) | youtube,tiktok,reels,script,pipeline,createur,video,calendrier,brief,contenu,idee |
...
• Brief de tournage (hook 3 s, plans, B-roll, CTA)
• Français et anglais
...
| Champ | Texte |
| --- | --- |
| **Subtitle** | Idea → script → published |
| **Promo** | A video pipeline that ships every week: idea, script, shoot brief, calendar. One next action. Not ten tabs. |
| **Keywords** | youtube,tiktok,reels,script,pipeline,creator,video,calendar,brief,content,ideas |
...
• Shoot brief (3 s hook, shots, B-roll, CTA)
• French and English
• Sign in with Apple
